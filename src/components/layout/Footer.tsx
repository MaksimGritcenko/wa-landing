...
export const Footer = ({ onContactClick, onPrivacyClick, onTermsClick }: FooterProps) => {
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <p className="text-obsidian-400 text-sm leading-relaxed mb-6">
                Premium web development agency specializing in building high-performance,
